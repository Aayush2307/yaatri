      ...
      <div className="mx-auto w-full px-4 md:px-8 lg:px-12 md:max-w-2xl pt-6">
        ...
        <section className="mt-4 md:mt-2">
          ...
          <p className="pt-3 text-sm leading-relaxed text-[#8A7665]">
            Meera helps with rituals, darshan timing, routes, and family needs.
          </p>
        </section>
        ...
        <section className="mt-6 rounded-2xl bg-gradient-to-br from-[#F8E9D3] via-[#FFFCF7] to-[#F4E2BF] p-5 shadow-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#8A7665]">Online now</p>
            </div>
            <a
              ...
              className="ml-auto flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] text-white shadow-sm"
            >
        ...
        <section className="mt-4 overflow-hidden rounded-2xl border border-[rgba(43,33,25,0.12)] bg-[#FFFCF7] shadow-sm" style={{ height: '60vh', minHeight: 480 }}>
          <ConciergeChat prefillQuery={prefill} />
        </section>
      </div>
