      ...
      <div className="mx-auto max-w-md space-y-3">
        ...
        <section className="rounded-card border-[0.5px] border-divider bg-white p-4">
          ...
          <ul className="space-y-2 pt-2 text-[13px] text-text-dark">
            <li className="flex items-center justify-between"><span>Abhishek seva</span><span className="text-success">Available</span></li>
            <li className="flex items-center justify-between"><span>Rudrabhishek</span><span className="text-gold-warm">On request</span></li>
