  ...
  return (
    <main className="min-h-screen bg-bg-surface px-5 pb-10 pt-6">
      <div className="mx-auto max-w-md space-y-3">
        {confirmed ? (
          <div className="rounded-card border-[0.5px] border-success/50 bg-success/10 px-3 py-2 text-[12px] text-success">
            Plan sent. Meera will reach you within 2 hours.
          </div>
        ) : null}
        ...
        <section className="rounded-card border-[0.5px] border-divider bg-white p-4">
          ...
          <ul className="space-y-2 pt-2 text-[13px] text-text-dark">
            ...
            <li className="flex items-center justify-between">
              ...
              <span className="text-gold-warm">Pending</span>
            </li>
          </ul>
        </section>
      </div>
